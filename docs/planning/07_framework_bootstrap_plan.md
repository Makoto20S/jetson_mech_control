...
| [ADR-018](../adr/ADR-018-upstream-target-lifetime.md) | Accepted | `DemoController` 上游目标暂定 100/106 ms，支持 20–50 Hz policy producer；硬件命令租约保持 4/6 ms，标准控制器弱档兼容性不变；Jetson 无设备测量不得表述为硬实时上界 |
