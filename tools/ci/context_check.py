...
EXPECTED_PACKAGES = {
    ...
    "mech_protocol_ctrboard": {"mech_control_core"},
...
REQUIRED_FILES = {
    ...
    "docs/adr/ADR-018-upstream-target-lifetime.md",
    "docs/adr/README.md",
    ...
    "ros2_ws/src/mech_protocol_ctrboard/package.xml",
    "ros2_ws/src/mech_ctrboard_bridge/package.xml",
